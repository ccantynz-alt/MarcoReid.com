...
export default function OraclePage() {
  return (
    <>
      ...
      <FAQ
        items={[
          { question: "How does citation verification work?", answer: "Every citation Marco returns is verified against authoritative public domain sources — CourtListener for case law, Cornell LII for US Code, IRS.gov for tax rulings, Congress.gov for legislation, USPTO for patents, BAILII for UK and Irish law, and CanLII for Canadian law. Each citation receives a Verified, Unverified, or Not Found badge so you always know the confidence level before relying on it." },
