...
export const metadata: Metadata = {
  title: "AlecRae Courtroom \u2014 The Most Advanced Courtroom Technology Ever Built",
  description:
    ...
    <>
        ...
        <Container>
          ...
          <Reveal delay={0.1}>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-navy-400">
              ...
              AlecRae Voice transcribes the entire proceeding in real time with legal vocabulary
          ...
          <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: "Real-time AI transcription", desc: "AlecRae Voice transcribes with legal vocabulary, speaker ID, and timestamps. Replaces $300\u2013500/day court reporters." },
        ...
        <Container>
          ...
          <Reveal delay={0.1}>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-navy-400">
              ...
              inside AlecRae, the court receives it electronically, and the filing is automatically
          ...
          <Reveal delay={0.15}>
            <div className="mt-10 rounded-xl bg-navy-500 p-8 sm:p-10">
              ...
              <p className="mt-4 font-serif text-headline text-white">
                When a court adopts AlecRae Courtroom for e-filing and document management,
                every attorney who appears in that court needs AlecRae to file.
              </p>
        ...
        <Container>
          <Reveal>
            ...
            <p className="mt-4 max-w-2xl text-lg text-navy-400">
              Courtroom features require explicit authorisation. Not every AlecRae Legal user
      ...
      <section className="py-24 sm:py-36" aria-label="Integration">
        <Container narrow>
          <Reveal>
            <h2 className="font-serif text-display text-navy-800">
              Deeply integrated with AlecRae Legal.
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-8 text-xl leading-relaxed text-navy-400">
              Matters from AlecRae Legal link directly to Courtroom proceedings.
              ...
              The Oracle available for real-time research. AlecRae Voice available for
