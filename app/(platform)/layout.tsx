...
function CommandPaletteTrigger() {
  ...
  return (
    <button
      onClick={open}
      className="hidden min-h-touch items-center gap-2 rounded-lg border border-navy-200 bg-white px-3 py-1.5 text-sm text-navy-400 transition-colors hover:border-navy-300 hover:text-navy-600 dark:border-navy-600 dark:bg-navy-800 dark:text-navy-400 dark:hover:border-navy-500 dark:hover:text-navy-200 sm:flex"
    ...
    >
      ...
      <kbd className="ml-2 rounded border border-navy-200 bg-navy-50 px-1.5 py-0.5 font-mono text-[10px] text-navy-500 dark:border-navy-600 dark:bg-navy-700 dark:text-navy-400">
        ⌘K
      </kbd>
    </button>
  );
