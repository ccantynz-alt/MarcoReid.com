  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:px-12">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-full bg-plum-50 px-4 py-1.5 text-xs font-bold text-plum-600">
          ADMIN
        </span>
      </div>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-navy-100 bg-white p-6 shadow-card">
          ...
          <p className="mt-2 font-serif text-3xl text-navy-700">
      ...
      <div className="mt-10 overflow-hidden rounded-xl border border-navy-100 bg-white shadow-card">
        <div className="border-b border-navy-100 px-6 py-4">
          <h2 className="font-semibold text-navy-700">All users</h2>
        </div>
        {loading ? (
