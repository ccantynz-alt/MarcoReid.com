...
export function CommandPaletteProvider({
  ...
  const commands: Command[] = useMemo(() => {
    ...
    return [
      ...
      {
        id: "nav-time",
        label: "Go to Time & Billing",
        section: "Navigate",
        action: nav("/time"),
        keywords: ["time", "billing", "hours", "timer"],
      },
      {
        id: "nav-payroll",
        label: "Go to Payroll Calculator",
        section: "Navigate",
        action: nav("/payroll"),
        keywords: ["payroll", "salary", "paye", "kiwisaver", "super", "ni"],
      },
      {
        id: "nav-tax",
        label: "Go to Tax Calculator",
        section: "Navigate",
        action: nav("/tax-calculator"),
        keywords: ["tax", "gst", "vat", "income tax", "corporate tax"],
      },
      {
        id: "nav-bank-feeds",
        label: "Go to Bank Feeds",
        section: "Navigate",
        action: nav("/bank-feeds"),
        keywords: ["bank", "plaid", "akahu", "feeds", "transactions"],
      },
      {
        id: "nav-signatures",
        label: "Go to E-Signatures",
        section: "Navigate",
        action: nav("/signatures"),
        keywords: ["signature", "sign", "esign", "docusign"],
      },
      {
        id: "nav-efiling",
        label: "Go to Court E-Filing",
        section: "Navigate",
        action: nav("/efiling"),
        keywords: ["efiling", "court", "filing", "pacer", "hmcts"],
      },
      {
        id: "nav-conflicts",
        label: "Go to Conflict Check",
        section: "Navigate",
        action: nav("/conflicts"),
        keywords: ["conflict", "check", "ethics"],
      },
      {
        id: "nav-audit",
        ...
        section: "Navigate",
        action: nav("/audit"),
        keywords: ["audit", "trail", "compliance", "log", "history"],
      },
      {
        id: "nav-intelligence",
        label: "Go to Proactive Intelligence",
        section: "Navigate",
        action: nav("/intelligence"),
        keywords: ["intelligence", "proactive", "alerts", "monitor"],
      },
      {
        id: "nav-predictions",
        label: "Go to Outcome Predictions",
        section: "Navigate",
        action: nav("/predictions"),
        keywords: ["predict", "outcome", "case", "success", "probability"],
      },
      {
        id: "nav-practice-intelligence",
        label: "Go to Practice Analytics",
        section: "Navigate",
        action: nav("/practice-intelligence"),
        keywords: ["practice", "analytics", "profitability", "capacity", "scope"],
      },
      {
        id: "nav-invoices",
        label: "Go to Invoices",
        section: "Navigate",
        action: nav("/billing/invoices"),
      ...
      },
      {
        ...
        section: "Navigate",
        action: nav("/deadlines"),
        keywords: ["deadline", "due", "filing", "calendar"],
      },
