      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="mt-8">
          <div className="rounded-2xl border border-navy-100 bg-white p-8 shadow-card">
            ...
            <div className="mt-5">
              <label htmlFor="firmName" className="block text-sm font-medium text-navy-600">
              ...
              />
              <p className="mt-1.5 text-xs text-navy-400">Optional. You can add this later.</p>
            </div>
            ...
            <div className="mt-6 flex items-start gap-3">
              ...
              <label htmlFor="agreed" className="text-sm text-navy-500">
                I agree to the{" "}
                <Link href="/terms" className="font-medium text-navy-700 underline hover:text-navy-500" target="_blank">
                  Terms of Service
                </Link>
                ,{" "}
                <Link href="/privacy" className="font-medium text-navy-700 underline hover:text-navy-500" target="_blank">
                  Privacy Policy
                </Link>
                , and{" "}
                <Link href="/acceptable-use" className="font-medium text-navy-700 underline hover:text-navy-500" target="_blank">
            ...
            <div className="mt-6 rounded-xl border border-navy-100 bg-navy-50 p-5">
              ...
              <div className="mt-4 flex items-start gap-3 border-t border-navy-100 pt-4">
                <input
                  ...
                  className="mt-1 h-4 w-4 rounded border-navy-300 text-navy-500 focus:ring-navy-500"
                />
                <label htmlFor="acked" className="text-sm font-medium text-navy-700">
            ...
            >
              {loading ? "Creating your account…" : isTrial ? "Start free trial" : "Create account"}
            </button>

            <p className="mt-4 text-center text-xs text-navy-400">
              By creating an account, you confirm that you have authority to bind your firm to these
