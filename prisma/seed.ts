...
const PRACTICE_AREAS = [
  ...
  },
  {
    ...
    jurisdiction: "NZ",
    summary:
      "Full company setup — NZ Ltd, family trusts, and cross-border overlays (Wyoming LLC for bootstrappers, Delaware C-Corp for VC-track) designed for aggressive asset protection.",
    intakeCopy:
    ...
    ackBullets: [
      ...
      "Cross-border structures (Wyoming LLCs, Delaware C-Corps, etc.) are packaged ready-to-execute — but the foreign entity is always formed by a lawyer admitted in that jurisdiction. Marco Reid coordinates, the local attorney executes.",
      ...
      "Asset-protection levels ('standard', 'aggressive') are design goals, not guarantees. A determined creditor with a court order can reach most assets; proper structure raises the cost and difficulty of reaching them.",
  ...
  },
  {
    ...
    jurisdiction: "AU",
    summary:
      "Full company setup — Pty Ltd, discretionary trusts, and cross-border overlays (Wyoming LLC for bootstrappers, Delaware C-Corp for VC-track) designed for aggressive asset protection.",
    intakeCopy:
